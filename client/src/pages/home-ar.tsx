    ...
    <div className="relative h-[100dvh] w-screen bg-[#e5815c] overflow-hidden" dir="rtl">
      ...
      <div className="internal-scroll-area">
        ...
        <section className="snap-slide relative overflow-hidden bg-[#fef8e1]">
          ...
          >
            <div className="relative mb-2 lg:mb-4 w-full max-w-6xl mx-auto overflow-hidden rounded-2xl lg:rounded-none" dir="ltr">
              {/* Layer 1: The GIF */}
              <img 
            ...
            <motion.button 
              ...
              className="px-10 py-5 rounded-full bg-[#eda78b] text-white font-black text-xs lg:text-sm uppercase tracking-[0.2em] border-[3px] border-black shadow-[4px_4px_0px_0px_#000] hover:shadow-[2px_2px_0px_0px_#000] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-200"
            >
              اختاري موديلك
            </motion.button>
          </motion.div>
              ...
              <div className="w-full max-w-lg mx-auto flex flex-col items-center justify-center mt-2 lg:mt-4">
                ...
                <div className="relative w-[12%] lg:w-[10%] z-30 hover:z-50 hover:scale-110 transition-transform">
                  ...
                  <motion.div 
                    ...
                    className="absolute top-1/2 -right-16 lg:-right-20 -translate-y-1/2 flex items-center space-x-1 flex-row-reverse"
                  >
                    <span className="font-serif font-black italic text-[9px] lg:text-xs text-[#000000]">توربان</span>
                ...
                <div className="relative w-[28%] lg:w-[25%] z-20 hover:z-50 hover:scale-110 transition-transform -mt-6 lg:-mt-4">
                  ...
                  <motion.div 
                    ...
                    className="absolute top-1/2 -left-16 lg:-left-20 -translate-y-1/2 flex items-center space-x-1 flex-row-reverse"
                  >
                    ...
                    <span className="font-serif font-black italic text-[9px] lg:text-xs text-[#000000]">بلوزة</span>
                  </motion.div>
                </div>
                ...
                <div className="w-full flex justify-center items-end gap-2 lg:gap-4 z-40 -mt-12 lg:-mt-10">
                  ...
                  <div className="relative w-[30%] lg:w-[28%] hover:scale-110 transition-transform">
                    ...
                    >
                      <span className="font-serif font-black italic text-[8px] lg:text-[10px] text-[#000000] mb-0.5 whitespace-nowrap">كيمونو قصير</span>
                      <svg className="w-2 h-2 lg:w-3 lg:h-3 -rotate-[135deg] scale-x-[-1]" viewBox="0 0 40 40" fill="none">
                        <path d="M2 38C15 30 25 15 38 2" stroke="#000000" strokeWidth="3" strokeLinecap="round" />
                      </svg>
                    </motion.div>
                  </div>
                  ...
                  <div className="relative w-[36%] lg:w-[32%] hover:scale-110 transition-transform">
                    <img src="/images/pieces/aqua-5.png" className="w-full h-auto drop-shadow-md scale-x-[-1]" alt="Whole Coverup" />
                     <motion.div 
                      ...
                      className="absolute -bottom-4 lg:-bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center"
                     >
                      <span className="font-serif font-black italic text-[8px] lg:text-[10px] text-[#000000] mb-0.5 whitespace-nowrap">كيمونو كامل</span>
                      <svg className="w-2 h-2 lg:w-3 lg:h-3 -rotate-[135deg] scale-x-[-1]" viewBox="0 0 40 40" fill="none">
                        <path d="M2 38C15 30 25 15 38 2" stroke="#000000" strokeWidth="3" strokeLinecap="round" />
                      </svg>
                    </motion.div>
                ...
                <div className="relative w-[22%] lg:w-[20%] z-10 hover:z-50 hover:scale-110 transition-transform -mt-6 lg:-mt-4">
                  ...
                  <motion.div 
                    ...
                    className="absolute top-1/2 -right-16 lg:-right-24 -translate-y-1/2 flex items-center space-x-1 flex-row-reverse"
                  >
                    <span className="font-serif font-black italic text-[9px] lg:text-xs text-[#000000]">ليجنز</span>
                    <svg className="w-3 h-3 lg:w-4 lg:h-4" viewBox="0 0 40 40" fill="none">
                      <path d="M2 38C15 30 25 15 38 2" stroke="#000000" strokeWidth="3" strokeLinecap="round" />
                    </svg>
                  </motion.div>
