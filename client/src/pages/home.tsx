              ...
              <div className="relative w-full aspect-[3/4] lg:aspect-square max-w-sm lg:max-w-md mx-auto mt-4 lg:mt-8">
                ...
                <div className="absolute top-[2%] left-1/2 -translate-x-1/2 w-[25%] lg:w-[18%] z-30 hover:z-50 hover:scale-110 transition-transform">
                  ...
                  <motion.div 
                    ...
                    className="absolute top-1/2 -left-6 lg:-left-12 -translate-y-1/2 flex items-center gap-1 lg:gap-2"
                  >
                    <span className="font-serif font-black italic text-[10px] lg:text-sm text-[#000000]">Turban</span>
                    <svg className="w-3 h-3 lg:w-5 lg:h-5 text-black scale-x-[-1]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M19 12l-7-7M19 12l-7 7"/></svg>
                  </motion.div>
                </div>
                ...
                <div className="absolute top-[16%] left-1/2 -translate-x-1/2 w-[60%] lg:w-[45%] z-20 hover:z-50 hover:scale-110 transition-transform">
                  ...
                  <motion.div 
                    ...
                    className="absolute top-1/2 -right-2 lg:-right-8 -translate-y-1/2 flex items-center gap-1 lg:gap-2"
                  >
                ...
                <div className="absolute top-[52%] left-1/2 -translate-x-1/2 w-[35%] lg:w-[28%] z-10 hover:z-50 hover:scale-110 transition-transform">
                  ...
                  <motion.div 
                    ...
                    className="absolute top-1/2 -left-8 lg:-left-16 -translate-y-1/2 flex items-center gap-1 lg:gap-2"
                  >
