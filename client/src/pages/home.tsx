        ...
        <section id="anatomy-section" className="snap-slide h-full px-4 lg:px-8 py-8 lg:py-16 flex flex-col justify-center overflow-hidden bg-[#fef8e1]">
          <div className="max-w-[95vw] lg:max-w-[90vw] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-16 items-center h-full">
            ...
            <div className="relative h-auto w-full flex flex-col items-center justify-center py-2 lg:py-0">
              ...
              <div className="relative w-full aspect-square max-w-sm lg:max-w-md mx-auto mt-4 lg:mt-8">
                {/* 1. Turban */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[22%] lg:w-[18%] z-30 hover:z-50 hover:scale-110 transition-transform">
                  <img src="/images/pieces/aqua-2.png" className="w-full h-auto drop-shadow-md" alt="Turban" />
                  <motion.div 
                    initial={{ opacity: 0, scale: 0 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    transition={{ type: "spring", stiffness: 260, damping: 20, delay: 0.1 }}
                    className="absolute top-1/2 -left-[120%] lg:-left-[140%] -translate-y-1/2 flex items-center gap-1 lg:gap-2"
                  >
                ...
                {/* 2. Top */}
                <div className="absolute top-[18%] lg:top-[15%] left-1/2 -translate-x-1/2 w-[55%] lg:w-[45%] z-20 hover:z-50 hover:scale-110 transition-transform">
                  <img src="/images/pieces/aqua-1.png" className="w-full h-auto drop-shadow-md" alt="Top" />
                  <motion.div 
                    initial={{ opacity: 0, scale: 0 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    transition={{ type: "spring", stiffness: 260, damping: 20, delay: 0.2 }}
                    className="absolute top-1/2 -right-[35%] lg:-right-[40%] -translate-y-1/2 flex items-center gap-1 lg:gap-2"
                  >
                ...
                {/* 3. Short Coverup */}
                <div className="absolute top-[48%] left-[2%] w-[42%] lg:w-[35%] z-40 hover:z-50 hover:scale-110 transition-transform">
                  ...
                  >
                    ...
                    <span className="font-serif font-black italic text-[8px] lg:text-[11px] text-[#000000] mb-0.5 whitespace-nowrap">Short Coverup</span>
                  </motion.div>
                </div>

                {/* 4. Whole Coverup */}
                <div className="absolute top-[48%] right-[0%] w-[48%] lg:w-[42%] z-40 hover:z-50 hover:scale-110 transition-transform">
                  ...
                  >
                    <svg className="w-3 h-3 lg:w-5 lg:h-5 text-black" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 19V5M12 5l-7 7M12 5l7 7"/></svg>
                    <span className="font-serif font-black italic text-[8px] lg:text-[11px] text-[#000000] mb-0.5 whitespace-nowrap">Whole Coverup</span>
                  </motion.div>
                </div>

                {/* 5. Leggings */}
                <div className="absolute bottom-[2%] lg:-bottom-[5%] left-1/2 -translate-x-1/2 w-[35%] lg:w-[28%] z-10 hover:z-50 hover:scale-110 transition-transform">
                  ...
                  <motion.div 
                    ...
                    className="absolute top-1/2 -left-[120%] lg:-left-[140%] -translate-y-1/2 flex items-center gap-1 lg:gap-2"
                  >
                    <span className="font-serif font-black italic text-[10px] lg:text-sm text-[#000000]">Leggings</span>
                    <svg className="w-3 h-3 lg:w-5 lg:h-5 text-black" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M19 12l-7-7M19 12l-7 7"/></svg>
                  </motion.div>
                </div>
              </div>
                  ...
                  >
                    <div className="flex items-center space-x-2">
                       <img 
                         ...
                         alt=""
                       />
                       <h4 className="font-serif font-black text-[10px] lg:text-xl text-[#000000] tracking-tight">{spec.title}</h4>
                    </div>
                     <p className="text-[8px] lg:text-sm font-bold text-[#5d4037] leading-tight italic max-w-sm">
                      {spec.text}
                    </p>
                  </motion.div>
                ))}
