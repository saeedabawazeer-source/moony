          ...
          <div className="max-w-[95vw] lg:max-w-[90vw] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-16 items-center h-full">
            ...
            <div className="relative h-auto w-full flex flex-col items-center justify-center py-2 lg:py-0">
              ...
              <div className="relative w-full aspect-[4/5] lg:aspect-square max-w-sm lg:max-w-md mx-auto mt-4 lg:mt-8">
                ...
                {/* Turban Label */}
                <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ delay: 0.1 }} className="absolute top-[8%] left-[15%] flex items-center gap-1 z-50 pointer-events-none">
                  <span className="font-serif font-black italic text-[11px] lg:text-sm text-[#000000]">Turban</span>
                  <svg className="w-4 h-4 text-black scale-x-[-1]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M19 12l-7-7M19 12l-7 7"/></svg>
                </motion.div>

                {/* Top Label */}
                <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="absolute top-[25%] right-[5%] lg:right-[10%] flex items-center gap-1 z-50 pointer-events-none">
                ...
                {/* Leggings Label */}
                <motion.div initial={{ opacity: 0, scale: 0 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ delay: 0.3 }} className="absolute top-[50%] left-[10%] flex items-center gap-1 z-50 pointer-events-none">
